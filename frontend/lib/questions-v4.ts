...
const EPSILON: Question[] = [
  ...
  q({
    ...
    category: 'map_relevance',
    operationContext:
      'Near-me pharmacy query. Rate each card for the shopper standing in Ocean City.',
    explanation:
      'The pharmacy is the on-category near-me hit (Excellent). Golden Dragon is a restaurant — Bad, user-intent issue, not a distance issue.',
    xpValue: 50,
    tags: ['map', 'near-me'],
    payload: {
  ...
  q({
    ...
    category: 'map_navigational',
    operationContext:
      'The query names a specific library. Decide whether any result is navigational.',
    explanation:
      'Ocean City Library is the intended destination — Navigational, and the query-level navigational flag is Yes. A hardware store is Bad.',
    xpValue: 50,
    tags: ['map', 'navigational'],
    payload: {
      query: 'Ocean City Library',
      user_location: 'Ocean City, NJ, US',
      user_location_pin: { lat: 39.2768, lng: -74.5742, label: 'You are here' },
      has_navigational_result: true,
      results: [
  ...
  q({
    ...
    category: 'map_accuracy',
    operationContext:
      'The pin is a block off and the street name is wrong. Rate fields independently.',
    explanation:
      'Relevance is still Excellent for an on-category nearby pizza place. Address is Incorrect (street name). Pin is Next Door. Name is Correct.',
    xpValue: 50,
      ...
      results: [
        {
          id: 'a',
          name_shown: 'Boardwalk Slices',
          address_shown: '1200 Asbury Ave, Ocean City, NJ 08226',
          category: 'Pizza restaurant',
          distance: '0.6 mi',
          pin_shown: { lat: 39.2752, lng: -74.563, label: 'Boardwalk Slices' },
          correct_relevance: 'Excellent',
          correct_relevance_subreason: null,
          correct_name_accuracy: 'Correct',
          correct_address_accuracy: 'Incorrect',
          correct_address_issue: 'Street Name',
          correct_pin_accuracy: 'Next Door',
          correct_business_closed: false,
        },
      ],
  ...
  q({
    ...
    category: 'map_closed',
    operationContext:
      'Coffee query. One chain store is closed; still rate relevance and tick Business Closed.',
    explanation:
      'A closed Starbucks stays a coffee result — Good/Excellent plus Business Closed. A diner is off-category (Bad).',
    xpValue: 50,
    tags: ['map', 'closed'],
    payload: {
      query: 'coffee',
      ...
      results: [
        {
          ...
          name_shown: 'Starbucks',
          address_shown: '2701 Ocean Heights Ave, Egg Harbor Township, NJ 08234',
          category: 'Coffee shop · Permanently closed',
          distance: '6.4 mi',
          pin_shown: { lat: 39.342, lng: -74.641, label: 'Starbucks' },
          correct_relevance: 'Good',
          correct_relevance_subreason: 'Dt.',
  ...
  q({
    ...
    difficulty: 'easy',
    category: 'map_relevance',
    operationContext: 'User wants pizza. Two on-category shops, different distances.',
    explanation:
      "Tony's is the closer excellent hit. Boardwalk Slices is still Good. No navigational result on a generic pizza query.",
    xpValue: 50,
    tags: ['map', 'near-me'],
    payload: {
      query: 'pizza near me',
      ...
      results: [
        {
          id: 'a',
          name_shown: "Tony's Pizza",
          address_shown: '932 Asbury Ave, Ocean City, NJ 08226',
          category: 'Pizza restaurant',
          distance: '0.2 mi',
          pin_shown: { lat: 39.2779, lng: -74.5749, label: "Tony's Pizza" },
          correct_relevance: 'Excellent',
...
const ZETA: Question[] = [
  ...
  q({
    ...
    category: 'needs_met',
    operationContext:
      'Restaurant homepage for a named-menu query. Rate both sliders.',
    explanation:
      'The restaurant page has a real menu and hours so PQ is Medium+/High. It Highly Meets a query for that restaurant’s menu. Fully Meets would need to be the only official destination for a clear website/nav query.',
    xpValue: 50,
    tags: ['pq', 'nm'],
    payload: {
      rubric: 'full',
  ...
  q({
    ...
    difficulty: 'easy',
    category: 'page_quality_only',
    operationContext: 'Page Quality only on an encyclopedia article. Do not submit Needs Met.',
    explanation:
      'Strong Main Content and reputation → High+. Highest is for the single dominant official source, not every good encyclopedia page.',
    xpValue: 50,
    tags: ['pq'],
    payload: {
      rubric: 'full',
      landing_page_snapshot_url: '/snapshots/zeta-encyclopedia.html',
      query: 'dehydration',
      user_intent: 'Learn what dehydration is.',
      ask_pq: true,
      ask_nm: false,
      correct_pq: 'High+',
      correct_flags: { porn: false, foreign_language: false, did_not_load: false },
  ...
  q({
    ...
    difficulty: 'hard',
    category: 'needs_met_only',
    operationContext: 'Needs Met only. The landing page is a junk supplement blog.',
    explanation:
      'Even without a PQ slider, a sales page that “cures dehydration” Fails to Meet a symptoms query. YMYL does not change the flags.',
    xpValue: 50,
    tags: ['nm', 'ymyl'],
    payload: {
      rubric: 'full',
  ...
  q({
    ...
    operationContext: 'Featured snippet / thin answer block. Rate Page Quality and Needs Met.',
    explanation:
      'A snippet that lists symptoms is helpful (Highly Meets) but the page itself is thin — Medium PQ, not High.',
    xpValue: 50,
    tags: ['pq', 'nm'],
    payload: {
      rubric: 'full',
  ...
  q({
    ...
    difficulty: 'hard',
    category: 'flags',
    operationContext: 'The snapshot did not load. Flag it. Do not invent a High page.',
    explanation:
      'Did Not Load + PQ N/A + Fails to Meet. Do not also invent Porn or Foreign Language.',
    xpValue: 50,
    tags: ['flags'],
    payload: {
      rubric: 'full',
...
const ETA: Question[] = [
  ...
  q({
    ...
    difficulty: 'medium',
    category: 'satisfaction',
    operationContext: 'Official park homepage for a trails query — related, not exact.',
    explanation:
      'The official Banff site is one hop from “Banff hiking trails”. Satisfying, not Highly Satisfying.',
    xpValue: 50,
    tags: ['lite', 's'],
    payload: {
      rubric: 'lite',
      landing_page_snapshot_url: '/snapshots/eta-banff.html',
      query: 'Banff hiking trails',
      user_intent: 'Find hiking trail information for Banff National Park.',
      correct_satisfaction: 'S',
      degrees_of_separation: 1,
      correct_flags: { wrong_language: false, content_unavailable: false, inappropriate: false },
    },
  ...
  q({
    ...
    difficulty: 'easy',
    category: 'satisfaction',
    operationContext: 'Wide-fit product listing for a wide-fit query.',
    explanation:
      'A retailer page of wide-fit hiking boots is Highly Satisfying when it is the exact product set the user asked for.',
    xpValue: 50,
    tags: ['lite', 'hs'],
    payload: {
      rubric: 'lite',
      landing_page_snapshot_url: '/snapshots/eta-boots-wide.html',
      query: 'wide fit hiking boots',
      user_intent: 'Buy hiking boots in a wide fit.',
      correct_satisfaction: 'HS',
      degrees_of_separation: 0,
      correct_flags: { wrong_language: false, content_unavailable: false, inappropriate: false },
    },
  ...
  q({
    ...
    difficulty: 'medium',
    category: 'flags',
    operationContext: 'Foreign-language page for an English official-site query.',
    explanation:
      'Wrong Language + Not Satisfying. Do not grade it Highly Satisfying just because it is “about Banff”.',
    xpValue: 50,
    tags: ['lite', 'language'],
    payload: {
      rubric: 'lite',
  ...
  q({
    ...
    difficulty: 'hard',
    category: 'flags',
    operationContext: 'The result did not load.',
    explanation:
      'Content Unavailable. Not Satisfying — the user got nothing they could use.',
    xpValue: 50,
    tags: ['lite', 'unavailable'],
    payload: {
      rubric: 'lite',
      landing_page_snapshot_url: '/snapshots/zeta-failed.html',
      query: 'Banff National Park official site',
      ...
      correct_satisfaction: 'NS',
      degrees_of_separation: 0,
      correct_flags: { wrong_language: false, content_unavailable: true, inappropriate: false },
    },
  }),
  q({
    id: 'eta_010',
    ...
    difficulty: 'easy',
    category: 'satisfaction',
    operationContext: 'General boots guide for a wide-fit shopping query.',
    explanation:
      'A generic “how to choose hiking boots” page is Somewhat Satisfying — related, not the wide-fit product.',
    xpValue: 50,
    tags: ['lite', 'ss'],
    payload: {
      rubric: 'lite',
...
const THETA: Question[] = [
  ...
  q({
    ...
    category: 'transcription',
    operationContext:
      'Filled pause “er” must be kept and tagged Unsure. Do not tidy the wording.',
    explanation:
      'Transcribe “So er how can I explain this.” Wrap “er” in Unsure. Two speakers; split at the long pause.',
    xpValue: 75,
    tags: ['transcription', 'unsure'],
    audioAssetUrl: '/audio/theta-001.wav',
    payload: {
      duration_seconds: 8,
      audio_asset_url: '/audio/theta-001.wav',
  ...
  q({
    ...
    category: 'transcription',
    operationContext:
      'The first word is cut by the recording. Truncated wins over Unsure.',
    explanation:
      'Use Truncated on the cut word. Do not also tag Unsure on the same span. Speaker IDs stay first-appearance order.',
    xpValue: 75,
    tags: ['transcription', 'truncated'],
    audioAssetUrl: '/audio/theta-001.wav',
    payload: {
      duration_seconds: 8,
      audio_asset_url: '/audio/theta-001.wav',
      weights: { segmentation: 0.25, speaker: 0.15, transcription: 0.2, tags: 0.4 },
      reference_audio_quality_flags: ['unclear_audio'],
      reference_segments: [
        {
          speaker: 1,
          gender: 'Female',
          ...
          end_ms: 2720,
          transcript: 'So how can I explain this.',
          tags: [{ type: 'truncated', start_char: 0, end_char: 2 }],
        },
        {
          speaker: 2,
          gender: 'Male',
  ...
  q({
    ...
    difficulty: 'medium',
    category: 'transcription',
    operationContext: 'Flag synthesized or recorded speech if the voice is not live.',
    explanation:
      'If the speech is generated or played back, tick Synthesized or Recorded. Still transcribe what you hear.',
    xpValue: 75,
    ...
    payload: {
      duration_seconds: 8,
      audio_asset_url: '/audio/theta-001.wav',
      reference_audio_quality_flags: ['synthesized_or_recorded'],
      reference_segments: [
        {
          speaker: 1,
          gender: 'Female',
  ...
  q({
    ...
    category: 'transcription',
    operationContext:
      'Unclear Audio plus a filled pause. Tag Unsure and select Unclear Audio.',
    explanation:
      'Noise that blocks a word is Unsure on the span and Unclear Audio on the clip. Do not use Truncated mid-clip.',
    xpValue: 75,
    tags: ['transcription', 'unclear'],
    audioAssetUrl: '/audio/proficiency-01.wav',
    payload: {
      duration_seconds: 6,
      audio_asset_url: '/audio/proficiency-01.wav',
      reference_audio_quality_flags: ['unclear_audio'],
      reference_segments: [
        {
          speaker: 1,
          ...
          start_ms: 0,
          end_ms: 5000,
          transcript: 'Please confirm the timestamps then send a corrected draft.',
          tags: [{ type: 'unsure', start_char: 0, end_char: 6 }],
        },
      ],
    },
  }),
  q({
    ...
    difficulty: 'easy',
    category: 'transcription',
    operationContext: 'One speaker. Keep grammar as spoken. Do not rewrite.',
    explanation:
      'One speaker, no tags. Transcribe what you hear. Do not fix grammar or drop filled pauses if they appear.',
    xpValue: 50,
    tags: ['transcription', 'verbatim'],
    audioAssetUrl: '/audio/proficiency-02.wav',
    payload: {
      duration_seconds: 6,
      audio_asset_url: '/audio/proficiency-02.wav',
      reference_audio_quality_flags: [],
      reference_segments: [
        {
          speaker: 1,
          ...
          start_ms: 0,
          end_ms: 5000,
          transcript: 'The draft is promising but it still needs a factual pass.',
          tags: [],
        },
      ],
    },
